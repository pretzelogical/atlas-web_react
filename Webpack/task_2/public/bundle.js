...
;// CONCATENATED MODULE: ./css/main.css
...
;// CONCATENATED MODULE: ./js/dashboard_main.js
...
const updateCounter = (() => {
  ...
  return () => {
    count += 1;
    jquery_default()('#count').text(count);
  }
})();

jquery_default()('button').on('click', (0,lodash.debounce)(updateCounter, 500));
